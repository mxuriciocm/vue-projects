...
<template>
  <pv-sidebar v-bind:visible="visible">
    <div v-for="source in sources" class="m-4">
      <div class="flex align-items-start flex-wrap" @click="onSourceSelected(source)">
        <span class="flex align-items-center justify-content-center mr-2">
          <pv-avatar :aria-label="source.name" :image="source.urlToLogo" shape="circle"></pv-avatar>
        </span>
